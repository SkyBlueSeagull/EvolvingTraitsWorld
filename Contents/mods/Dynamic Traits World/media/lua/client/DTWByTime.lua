...
local function calculateAverage(values)
    ...
    for i, value in ipairs(values) do
        sum = sum + value;
        --print("DTW Logger: Value in modData.Last100PreferredHour = "..value);
    end
    return sum / #values
end
...
local function sleepSystem()
    ...
    if not player:isAsleep() and modData.CurrentlySleeping == true then
        ...
        if modData.WentToSleepAt > timeOfDay then
            ...
            --print("DTW Logger: findMidpoint("..modData.WentToSleepAt..", "..24 + timeOfDay..")="..findMidpoint(modData.WentToSleepAt, 24 + timeOfDay));
            ...
            --print("DTW Logger: old currentPreferredTargetHour: "..currentPreferredTargetHour)
            --print("DTW Logger: findMidpoint("..modData.WentToSleepAt..", "..timeOfDay..")="..findMidpoint(modData.WentToSleepAt, timeOfDay));
    ...
    --print("DTW Logger: modData.SleepHealthinessBar: "..modData.SleepHealthinessBar);
end
